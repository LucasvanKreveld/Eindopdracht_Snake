...
def momenteel_doodloopcheck_veld(level_breedte, level_hoogte, level, positie, f): 
    ...
    while j < level_breedte:
        k = 0
        while k < level_hoogte:
            momenteel_doodloopcheck(j, k, level_hoogte, level_breedte, level, positie, f, doodlopend_momenteel_weergave, doodlopend_momenteel_lijst)
            k += 1
        j += 1
...
def momenteel_doodloopcheck(j, k, level_hoogte, level_breedte, level, positie, f, doodlopend_momenteel_weergave, doodlopend_momenteel_lijst):
